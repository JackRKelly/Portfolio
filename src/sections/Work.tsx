...
export function Work(props: Props) {
	const {isMobile, viewport, setIsModalOpen, setModalInfo} = props;
		...
		<section id="work">
			<Content>
				...
				<WorkWrapper>
					...
					/>
					<WorkCard
						description="J2 Business Site is a mock business site built to showcase Jack Kelly’s work. There is a contact page utilizing Netlify Forms to handle form submission. This website was awarded 2nd place in the 2019 eMagine Media festival. This site was built using HTML, CSS, JavaScript, Netlify, and Fullpage.js."
					...
					/>
					<WorkCard
						description="Rails Recipe is a recipe sharing website built using Ruby on Rails, React, Styled Components, and Typescript. You can create and preview recipes on Rails Recipe. The Ruby on Rails REST API supports read, delete, and create operations. Rails Recipe uses react toastify for notificaiton toasting."
						title="Rails Recipe"
						primaryColor="#1d998b"
