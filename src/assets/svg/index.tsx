...
interface HeroShapesProps {
	parallax: AnimatedValue<
		Pick<
			OverwriteKeys<
				{xy: number[]; config: {mass: number; tension: number; friction: number}},
				React.CSSProperties
			>,
			'xy'
		>
...
export const HeroShapes = React.forwardRef(
	(
		props: HeroShapesProps,
		ref:
		...
		return (
			<div ref={ref}>
				<animated.div
					...
					style={{
						transform: parallax.xy.interpolate(xy => trans5(xy[0], xy[1])),
					}}
				>
					<Img
						lazy
				...
				<div className="hero-shapes-wrapper">
					...
					>
						<animated.g
							...
							data-name="Polygon 4"
							style={{
								transform: parallax.xy.interpolate(xy => trans3(xy[0], xy[1])),
							}}
						>
							<path
						...
						<animated.g
							...
							data-name="Group 186"
							style={{
								transform: parallax.xy.interpolate(xy => trans4(xy[0], xy[1])),
							}}
						>
						...
						<animated.g
							...
							data-name="Group 191"
							style={{
								transform: parallax.xy.interpolate(xy => trans2(xy[0], xy[1])),
							}}
						>
							<rect
						...
						<animated.g
							...
							data-name="Group 194"
							style={{
								transform: parallax.xy.interpolate(xy => trans1(xy[0], xy[1])),
							}}
						>
...
export function ExternalLinkIcon() {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
			...
			<path
				d="M19,19H5V5h7V3H5A2,2,0,0,0,3,5V19a2,2,0,0,0,2,2H19a2,2,0,0,0,2-2V12H19Z"
...
export function JRKLogo() {
	return (
		<svg
			id="JRKLogo"
			data-name="JRKLogo"
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 1398.89 591.4"
		>
			<polygon
				points="1178.6,269.9 1377.1,4.2 1210.5,4.2 1043.6,210.8 1043.6,4.2 899.6,4.2 899.6,587.2 1043.6,587.2 1043.6,424.8
		1082.2,379.1 1224.6,587.2 1398.9,587.2 	"
			/>
			<path
				d="M68.4,142.3h169.7V403c0,24.5-4.5,40.3-13.9,48.5c-8.7,7.6-21.8,8.2-32.2,8.8l-1.8,0.1c-7.1,0.4-15,0.8-24.1-2.7
		c-8.9-3.4-16.5-9.6-22.6-18.2c-3.2-4.4-5.7-9.3-7.6-14.4c-2-5.8-2.8-11.1-3.4-22.9c-0.6-12.3-0.6-25,0-37.6l0.7-15.3l-15.4,0.1
		c-17.1,0.2-34.3,0.2-51.5,0.2c-17.2,0-34.6-0.1-51.6-0.2L0,349.2L0.2,364c0.2,13.3,0.2,27,0,40.6c-0.2,16.1-0.2,19.3,0,24.2
		c0.9,19.1,5.9,38.6,15,58.2l0.4,0.7c14.2,26.7,34.4,49.7,59,67.4c48.5,34.5,98.3,36.2,118.4,36.2l3.2,0
		c26.8-0.1,89.7-0.5,138.3-49.9c31.8-32.3,47.9-78.3,47.9-136.7V0.1H68.4V142.3z"
			/>
			<path
				d="M824.5,343.2c20.2-31.5,30.4-70.6,30.4-116.2c0-35.8-6.2-68.4-18.4-96.8c-11.9-28-30.3-52.7-53.7-72.1
		c-23.1-19.2-51.4-33.9-84.2-43.7C666.3,4.9,629.4,0,589,0H419v591.4h144.8V451.6H589c8.7,0,17.3-0.5,25.9-1.4l91.9,141.2h168.9
		L753.2,407.2C783.8,390.8,807.8,369.3,824.5,343.2z M563.8,130.7h21.9c87.1,0,121.1,27,121.1,96.3c0,35.4-8.5,58.6-26.9,73
		c-18.6,14.6-49.4,21.7-94.2,21.7h-21.9L563.8,130.7z"
			/>
		</svg>
	);
}
...
export function JRKLogoStroke() {
	return (
		<svg id="JRKLogo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 